...
export function AutoDoc(props) {
    ...
    <div class="flex">
        ...
        <div class="flex-auto flex align-items-center justify-content-center bg-primary font-bold m-2 px-5 py-3 border-round">Mantle UI and Mantle Flex</div>
            ...
            <div className="card">
                <div className="card-container">
                    <div className="flex">
                        ...
                        <div className="flex align-items-center justify-content-center bg-primary font-bold m-2 px-5 py-3 border-round">Mantle UI and Mantle Flex</div>
                    ...
                    <div className="flex">
                        ...
                        <div className="flex-auto flex align-items-center justify-content-center bg-primary font-bold m-2 px-5 py-3 border-round">Mantle UI and Mantle Flex</div>
