...
const PositionPage = () => {
    ...
    return (
        <div>
            <Head>
                <title>Align Content - Mantle Flex</title>
                <meta name="description" content="Mantle Flex Align Content controls the distribution of flex lines between and around items." />
            </Head>
            <div className="doc">
