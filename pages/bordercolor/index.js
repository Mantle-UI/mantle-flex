...
const PositionPage = () => {
    ...
    return (
        <div>
            <Head>
                <title>Border Color - Mantle Flex</title>
                <meta name="description" content="Mantle Flex Border Color is a wide range of color palettes for the border of an element." />
            </Head>
            <div className="doc">
