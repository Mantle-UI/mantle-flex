...
const PositionPage = () => {
    ...
    return (
        <div>
            <Head>
                <title>Transition Duration - Mantle Flex</title>
                <meta name="description" content="Mantle Flex Transition Duration defines how long a transition should take to complete." />
            </Head>
            <div className="doc">
